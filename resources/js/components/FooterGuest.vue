<template>
  ...
  <div class="footer  justify-center">
    <div class="">
        <div class="container grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 px-3 max-w-5xl">
            
            <div class="column-1">
                <h4>Scopri Deliveboo</h4>
                <ul>
                  <li v-for="(el, i) in UlDiscover" :key="i">
                                <a href="">
                                {{ el.text}}
                                </a> 
                  </li>
            ...
            <div class="column-2">
                <h4>Note legali</h4>
                <ul>
                  <li v-for="(el, i) in UlLegal" :key="i">
                                <a href="">
                                {{ el.text}}
                                </a> 
                  </li>
        ...
        <div class="row-down container grid grid-cols-2 justify-between gap-3 px-3 max-w-5xl">
          <div class="social-wrapper flex ">
            <svg height="22" width="22" viewBox="0 0 24 24" role="presentation" focusable="false" class="ccl-0f24ac4b87ce1f67 ccl-abe5c41af1b9498e">
