        ...
        <div class="">
          <nav class="mb-6 font-bold">
            <router-link
              ...
              class="text-stone-700 border border-deliveroo hover:text-white hover:bg-deliveroo px-2 py-1 rounded"
            >
              Ristoranti
            </router-link>
          </nav>
          ...
          <div class="flex flex-wrap gap-3 mb-5">
            <figure
              class="max-w-lg rounded-lg overflow-hidden shadow-lg shadow-stone-600"
            >
            ...
            <div class="grow ml-4">
              ...
              <div><span>📍 </span>{{ restaurant.city }} - {{ restaurant.address }}</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div v-if="plates.length == 0">
              ...
              <p>
                ...
                <router-link
                  :to="{ name: 'restaurant.index' }"
                  class="text-deliveroo font-bold"
                  >Home</router-link
                >
            ...
            <div v-else class="grid gap-10 plate-container mb-[15px]">
              <div
                class="flex gap-3 bg-stone-100 p-4 rounded shadow-lg shadow-stone-600 plate-card border-2 border-transparent"
              ...
              >
                <div class="grow">
                  ...
                  <div>
                    ...
                    <button
                      class="text-slate-50 bg-viola rounded-lg px-[15px] pointer font-semibold"
